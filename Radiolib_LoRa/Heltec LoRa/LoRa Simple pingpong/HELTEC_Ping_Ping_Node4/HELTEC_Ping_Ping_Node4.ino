...
Ce programme correspond au noeud Node4 et envoie le String "Node4" à la passerelle lorsqu'il reçoit un message, de la part de la passerelle, contenant son adresse.
*/
