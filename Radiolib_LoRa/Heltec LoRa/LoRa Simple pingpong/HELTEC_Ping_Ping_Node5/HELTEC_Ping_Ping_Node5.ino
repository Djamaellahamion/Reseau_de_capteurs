...
Ce programme correspond au noeud Node5 et envoie le String "Node5" à la passerelle lorsqu'il reçoit un message, de la part de la passerelle, contenant son adresse.
*/
...
void loop() {
  ...
  if(operationDone) {
    ...
    if(transmitFlag) {
      ...
      transmissionState = radio.startTransmit("Node5");
      transmitFlag = true;
        if (state == RADIOLIB_ERR_NONE) {
