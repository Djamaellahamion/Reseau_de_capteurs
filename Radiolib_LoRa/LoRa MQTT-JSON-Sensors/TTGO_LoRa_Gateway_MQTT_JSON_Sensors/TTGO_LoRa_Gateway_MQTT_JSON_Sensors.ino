...
Le message reçu est un object JSON qui contient la salle, le numéro du Node ayant envoyé le message ainsi que son adresse et les données du capteur rattaché au Node.
...
Le programme permet aussi de rajouter dans l'object JSON le rssi et le snr LoRa du message reçu par la Gateway avant la publication sur le broker*/
