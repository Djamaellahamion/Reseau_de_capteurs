...
Ce programme correspond au noeud Node3 et envoie le String "Node3" à la passerelle lorsqu'il reçoit un message, de la part de la passerelle, contenant son adresse.
*/
...
void loop() {
  ...
  if(operationDone) {
    ...
    if(transmitFlag) {
      ...
      transmissionState = radio.startTransmit("Node3");
      transmitFlag = true;
        if (state == RADIOLIB_ERR_NONE) {
