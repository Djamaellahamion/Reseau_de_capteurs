...
volatile bool operationDone = true;  // mettre à true pour le gateway
  ...
  if (operationDone) {
    ...
    if (transmitFlag) {
      ...
      if (transmissionState == RADIOLIB_ERR_NONE) {
        ...
        factory_display.drawString(0, 0,"Transmission to Node"+String(count)+" succeed");
        factory_display.display();
        delay(100);
        factory_display.clear();
        ...
        factory_display.drawString(0, 0,"Transmission to Node"+String(count)+" failed");
        factory_display.display();
        delay(100);
        factory_display.clear();
      }
      ...
      if (state == RADIOLIB_ERR_NONE) {
        ...
        factory_display.drawString(0, 0,"Received message from Node"+String(count));
        factory_display.display();
        delay(100);
        factory_display.clear();
